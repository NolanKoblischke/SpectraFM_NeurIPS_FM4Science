1. Download [allStar](https://data.sdss.org/datamodel/files/APOGEE_ASPCAP/APRED_VERS/ASPCAP_VERS/allStar.html) which contains the labels for each star (temperature, chemical abundances, etc.)
