# Script to collect PyTorch environment information
# Originally from https://raw.githubusercontent.com/pytorch/pytorch/main/torch/utils/collect_env.py
import locale
import re
import subprocess
import sys
...
def get_env_info():
    ...
    return SystemEnv(
        ...
        nvidia_gpu_models=(get_gpu_info(run_lambda) or "").replace("\n\n", "\n"),
...
def get_torch_env_info():
    return pretty_str(get_env_info()).replace("\r", "")